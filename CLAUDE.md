...
- **Graceful degradation**: optional backends (YuNet faces, beat-this, Qwen, DINOv2 embeddings, all-in-one-mlx/demucs-mlx, cairosvg for Motion text) fall back with one log line when missing; kill switches: `BEATSYNC_DISABLE_QWEN/EMBED/STRUCTURE/STEMS/STYLEDTEXT`, `BEATSYNC_YUNET_MODEL`, `BEATSYNC_BEAT_BACKEND`.
