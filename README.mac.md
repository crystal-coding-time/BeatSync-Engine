...
- **Effect intensity** (Advanced) — scales all effect strengths.
...
- **Speed ramps (experimental, Advanced)** — opt-in: slow-motion drifts through calm segments, speed-ups through builds, decelerating hits into drops, and rare freeze-frames. Frame-count-safe by construction (every retimed segment is verified after extraction); skips images, low-fps sources, and ProRes mode.
